...
[境界体系]
顺序:凡人→练气→筑基→金丹→元婴→化神→炼虚→合体→渡劫
阶段:初期→中期→后期→圆满→极境(罕见)
禁止层数:严禁用"练气一层/二层...十二层"等层数表述境界,必须使用初期/中期/后期/圆满/极境
...
路径:角色.大道.大道列表.{道名}
指令:新悟大道set完整DaoData(道名/当前阶段/当前经验/总经验/阶段列表/感悟记录/关联);增经验add当前经验;升阶段add当前阶段(value:1)
...
□ 战斗:〔战斗:惨败,判定值:25,难度:60,练气后期vs筑基初期,境界压制〕
□ 突破:〔突破:失败,判定值:35,难度:60,金丹圆满,进度-30%,走火〕
□ 交涉:〔交涉:拒绝,判定值:20,难度:50,好感度-20,立场敌对〕
□ 搜索:〔搜索:无获,判定值:30,难度:55,练气期vs金丹洞府〕
